...
$copy = [
    'en' => [
        ...
        'sections' => [
            ...
            ['Photos, recordings and homework history', 'Discovery photos and recordings are processed only during a discovery. The photo is resized and recreated before analysis, removing metadata such as location. For homework help, Lumi keeps the response and spoken explanation in the private account history so the child can revisit them. When the child chooses an annotated-photo answer, that private image includes the photographed page and Lumi’s answer. The original recording is not kept.'],
    ...
    'pt' => [
        ...
        'sections' => [
            ...
            ['Fotos, gravações e histórico da lição', 'Fotos e áudios de descoberta são processados somente durante a descoberta. A foto é redimensionada e recriada antes da análise, removendo metadados como localização. Na ajuda com a lição, a Lumi guarda a resposta e a explicação em áudio no histórico privado da conta para a criança poder revisitar. Quando a criança escolhe resposta na foto, essa imagem privada inclui a página fotografada e a resposta da Lumi. A gravação original não fica armazenada.'],
    ...
    'es' => [
        ...
        'sections' => [
            ...
            ['Fotos, grabaciones e historial de tareas', 'Las fotos y los audios de descubrimiento se procesan solo durante el descubrimiento. La foto se redimensiona y se recrea antes del análisis, eliminando metadatos como la ubicación. En la ayuda con tareas, Lumi conserva la respuesta y su explicación en audio en el historial privado de la cuenta para que el niño pueda volver a verlas. Cuando el niño elige una respuesta en la foto, esa imagen privada incluye la página fotografiada y la respuesta de Lumi. La grabación original no se guarda.'],
